...
class ShopProfileSales extends StatefulWidget {
  static String id = 'shop_profile_sales';
  var shopID;
  var name;

  ShopProfileSales(this.shopID, this.name);
  @override
  _ShopProfileSalesState createState() => _ShopProfileSalesState();
}

class _ShopProfileSalesState extends State<ShopProfileSales> {
