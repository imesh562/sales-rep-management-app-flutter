...
import 'package:dk_brothers/components/shop_profile_pie.dart';
import 'package:dk_brothers/screens/shop_profile_payments.dart';
import 'package:dk_brothers/screens/shop_profile_sales.dart';
...
class ShopProfile extends StatefulWidget {
  ...
  ShopProfile(
      this.location, this.name, this.telNumber, this.shopID, this.shopStatus);
  @override
...
class _ShopProfileState extends State<ShopProfile> {
  ...
  waitingList() async {
    ...
    ShopPieData obj1 = ShopPieData();
    await obj1.getShopPie(widget.shopID);
    await obj1.getItemsNames();
    await getPayments();
    await getSales();
    await getData();
    if (this.mounted)
          ...
          child: Container(
            child: Column(
              children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Balance: ' + (sales - payments).toString(),
                            style: TextStyle(
                ...
                CarouselSlider(
                  items: [carouselList2(mediaData), carouselList(mediaData)],
                        ...
                        onTap: () {
                          pushNewScreenWithRouteSettings(
                            ...
                            settings: RouteSettings(
                              name: ShopProfileSales.id,
                            ),
                            screen:
                                ShopProfileSales(widget.shopID, widget.name),
                            withNavBar: true,
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          pushNewScreenWithRouteSettings(
                            context,
                            settings: RouteSettings(
                              name: ShopProfilePayments.id,
                            ),
                            screen:
                                ShopProfilePayments(widget.shopID, widget.name),
                            withNavBar: true,
                            pageTransitionAnimation:
                                PageTransitionAnimation.cupertino,
                          );
