...
class RepProfilePayments extends StatefulWidget {
  static String id = 'rep_profile_sales';
  var repID;
  var name;

  RepProfilePayments(this.repID, this.name);
  @override
  _RepProfilePaymentsState createState() => _RepProfilePaymentsState();
}

class _RepProfilePaymentsState extends State<RepProfilePayments> {
